...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gridView = view.findViewById(R.id.grid_view_news);
        TextView title = view.findViewById(R.id.header);
        TextView subtitle = view.findViewById(R.id.subheader_title);

        PhotoAdapter adapter = new PhotoAdapter(PhotoData.generatePhoto(), getActivity().getApplicationContext());
    ...
    private AdapterView.OnItemClickListener onitemclick = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
            Intent intent = new Intent(getContext(), ViewPhotoDetail.class);
