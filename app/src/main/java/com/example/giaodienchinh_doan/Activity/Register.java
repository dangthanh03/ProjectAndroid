...
import com.example.giaodienchinh_doan.Activity.MainActivity;
...
public class Register extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        if(currentUser != null){
            ...
            Intent intent= new Intent(getApplicationContext(), com.example.giaodienchinh_doan.Activity.Login.class);
